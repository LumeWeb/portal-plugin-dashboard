...
require (
	...
	go.lumeweb.com/web/go/portal-dashboard v0.0.0-20250901074043-246374b6aaa1
	go.lumeweb.com/web/go/portal-plugin-dashboard v0.0.0-20250901074043-246374b6aaa1
