...
into the `internal/caip122` package, along with their original authors and
licenses.
...
- **Usage:** EIP-4361 (SIWE) message parsing, construction, verification, and
  regex parser. Source code vendored and adapted into `internal/caip122/message.go`.
  Original tests ported into `internal/caip122/message_test.go`.
- **Modifications:**
...
- **Usage:** JSON test vectors for EIP-4361 parsing and verification. Copied
  into `internal/caip122/testdata/`:
